...
mixin _$ProfileFailure {
  ...
  Result when<Result extends Object>({
    ...
    @required Result unknownFailure(),
  });
  @optionalTypeArgs
  ...
  Result map<Result extends Object>({
    ...
    @required Result unknownFailure(_UnknownFailure value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result insufficientPermission(_InsufficientPermission value),
    Result unknownFailure(_UnknownFailure value),
    @required Result orElse(),
  });
}
...
class _$_UnknownFailure implements _UnknownFailure {
  ...
  @override
  String toString() {
    return 'ProfileFailure.unknownFailure()';
  }
...
abstract class _UnknownFailure implements ProfileFailure {
